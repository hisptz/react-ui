...
export function useManageLegendDefinitions(legendDefinitions: LegendDefinition[], {
  onChange,
  shouldVerify,
  onResetLegends
}: {
  onChange: (definitions: LegendDefinition[]) => void, shouldVerify: boolean, onResetLegends: (newDefinitions: LegendDefinition[]) => void
}) {
